...
- `.github/workflows/deploy.yml`
  - VPS への反映だけを担当する。
  - `workflow_dispatch` の手動実行のみ有効にし、標準では `latest` tag、必要に応じて commit SHA tag を指定してデプロイする。
